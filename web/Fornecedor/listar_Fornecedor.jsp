                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link" href="http://localhost:8080/CrudJavaWeb/Fornecedor/frm_Fornecedor.html">

      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="http://localhost:8080/CrudJavaWeb/Funcionario/listar_Funcionario.jsp">
...
<form action="alterar_Funcionario.jsp" method="POST">
<div class="container">
<div class="jumbotron bg-dark text-light mt-3">
    ...
    <br>
        ...
        <input class="form-control" type="text" id="cargo" name="cargo" value="<%=request.getParameter("cargo")%>" required>
    <br>
        <label for="cpf">CPF ou CNPJ: </label>
        <input class="form-control" type="text" id="cpf" name="cpf" value="<%=request.getParameter("cpf")%>" required>
    <br>
        <label for="rg">RG ou IS : </label>
        <input class="form-control" type="text" id="rg" name="rg"  value="<%=request.getParameter("rg")%>"required>
    <br>
